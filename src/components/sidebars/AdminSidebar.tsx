...
export const AdminSidebar: React.FC<{ className?: string }> = ({}) => {
    ...
    const sidebarItems: SidebarItem[] = [
        ...
        },
        {
            ...
            children: [
                ...
                { label: 'Produits', href: '/admin/ressources/produits' },
            ],
        },
        {
    ...
    return (
        <div className={`${isCollapsed ? 'w-20' : 'w-80'} h-screen rounded-tr-[24px] rounded-br-[24px] bg-secondary text-white flex flex-col transition-all duration-300`}>
            {/* Logo et Toggle */}
