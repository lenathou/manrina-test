...
export const ProducteurMobileSidebar: React.FC<ProducteurMobileSidebarProps> = ({ onClose }) => {
    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-primary text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center hover:scale-105 active:scale-95 md:hidden"
                aria-label="Menu de navigation"
            >
                <div className="relative w-6 h-6">
                    <span
                        className={`absolute block w-6 h-0.5 bg-white transition-all duration-300 ${
                            isOpenState ? 'rotate-45 top-3' : 'top-1'
                        }`}
                    />
                    <span
                        className={`absolute block w-6 h-0.5 bg-white transition-all duration-300 top-3 ${
                            isOpenState ? 'opacity-0' : 'opacity-100'
                        }`}
                    />
                    <span
                        className={`absolute block w-6 h-0.5 bg-white transition-all duration-300 ${
                            isOpenState ? '-rotate-45 top-3' : 'top-5'
                        }`}
                    />
                </div>
            </button>
