...
export const ManrinaMarketLink: React.FC<ManrinaMarketLinkProps> = ({ className }) => {
    ...
    return (
        <div
            className={`w-full mx-auto my-4 ${className || ''}`}
            style={{ maxWidth: '850px', paddingLeft: '16px', paddingRight: '16px' }}
        >
            <button
                onClick={handlePress}
            ...
            >
                ...
                <div className="flex items-center gap-4 relative z-10">
                    ...
                    <div className="flex-1 text-left">
                        <h3 className="text-xl font-bold text-white mb-1 group-hover:text-primary transition-colors drop-shadow-sm">
                            Nos Événements Manrina
                        </h3>
                        <p className="text-sm text-white group-hover:text-primary transition-colors drop-shadow-sm">
