                ...
                <div className="space-y-6">
                    ...
                    {activeTab === 'variant' && (
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Type d'option *</label>
                                <input
                                    type="text"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">URL image du variant</label>
                            <input
                                type="url"
