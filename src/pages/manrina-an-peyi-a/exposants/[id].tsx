            ...
            <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
                <div className="max-w-4xl mx-auto px-4 py-8">
                    ...
                    <div className="text-center py-12">
                        <Text variant="h2" className="text-gray-500 mb-4">
                            Exposant non trouvé
                        </Text>
            ...
            <main className="max-w-6xl mx-auto px-4 py-8">
                    ...
                    <CardContent className="p-8">
                        <div className="flex flex-col lg:flex-row gap-8">
                            ...
                            <div className="flex-1">
                                <Text variant="h1" className="text-3xl font-bold text-gray-900 mb-4">
                                    {exhibitor.name}
                                </Text>
                                
                                {exhibitor.description && (
                                    <Text variant="body" className="text-gray-600 mb-6 leading-relaxed">
                                        {exhibitor.description}
                                    </Text>
                                )}
                ...
                <Tabs defaultValue={activeTab} className="w-full">
                    <TabsList className="grid w-full grid-cols-2 mb-8">
                        <TabsTrigger value="bio" className="text-lg py-3">
                            Biographie
                        </TabsTrigger>
                        <TabsTrigger value="produits" className="text-lg py-3">
                            ...
                            <CardContent>
                                <div className="prose max-w-none">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                                        <div>
                                            <Text variant="h5" className="font-semibold mb-3">
                                                Spécialités
                                            </Text>
                            ...
                            {exhibitor.products.length > 0 ? (
                                ...
                                <Card>
                                    <CardContent className="p-8 text-center">
                                        ...
                                        <Text variant="h4" className="text-gray-500 mb-2">
