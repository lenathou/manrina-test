...
const LivreurSecurityPage: React.FC = () => {
    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
        <div className="mb-8">
          ...
          <p className="text-[var(--muted-foreground)] text-lg">
            Gérez les paramètres de sécurité de votre compte livreur
          </p>
        </div>
        ...
        <div className="grid gap-6 max-w-4xl">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Changez votre mot de passe pour sécuriser votre compte livreur
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                  <h3 className="font-semibold text-green-900 mb-2">
                    Sécurité de vos livraisons :
                  </h3>
                  <ul className="text-green-800 space-y-1 text-sm">
                    <li>• Protégez l'accès à vos informations de livraison</li>
                    <li>• Vérifiez régulièrement vos tournées assignées</li>
...
export default LivreurSecurityPage;