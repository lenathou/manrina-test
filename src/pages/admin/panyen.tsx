            ...
            <div className="bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">Nom du panyen *</label>
                            <input
                                type="text"
                                value={name}
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    handleQuantityChange(component.id, parseInt(e.target.value) || 1)
                                                }
                                                ...
                                                {product.variants.map((variant) => (
                                                    ...
                                                    >
                                                        <div className="flex justify-between items-center">
                                                            <span>
                                                                {variant.optionSet}: {variant.optionValue} -{' '}
                                                                {variant.price}€
                                                            </span>
            ...
            <div className="flex-1 bg-white rounded-lg p-6 max-w-7xl mx-auto">
                ...
                <div className="mb-6">
                    <p className="text-gray-600 mb-4">
                        Les panyen sont des produits composés de plusieurs produits différents. Leur stock est
                        automatiquement calculé en fonction du stock des produits qui les composent.
                    </p>
                    <SearchBarNext
