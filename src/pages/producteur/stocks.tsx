...
function GrowerStocksPage({ authenticatedGrower }: { authenticatedGrower: IGrowerTokenPayload }) {
    ...
    const addableProducts = allProducts.filter(
        (p) => p.showInStore && !growerProducts.some((gp) => gp.id === p.id),
    );
        ...
        <div className="flex flex-col min-h-screen bg-background">
            ...
            <div className="mx-8 p-8 bg-white rounded">
                <div className="flex justify-between items-center mb-4">
                    <Text variant="h3">Mes produits</Text>
                    ...
                    {growerProducts.length > 0 && (
                        <div className="flex gap-3">
                            ...
                            >
                                {isValidating ? 'Validation en cours...' : 'Valider tous les stocks'}
                            </Button>
                        </div>
                    )}
                </div>
            ...
            {showPriceModal && selectedProduct && (
                <GrowerPriceModal
                    ...
                    currentPrices={selectedProduct.variants.reduce((acc, v) => {
