...
export default function ProducteurLoginPage() {
  ...
  const handleLoginError = (error: LoginError) => {
    ...
    if (typeof error === 'string') {
      ...
      } else if (error.includes('SIRET')) {
        globalErrorData = {
          type: 'validation',
          message: 'Numéro SIRET incorrect',
          details: 'Vérifiez votre numéro SIRET et réessayez.'
        };
  ...
  return (
    <div className="min-h-screen  flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        ...
        {/* Form */}
        <div className="p-6">
          <GrowerLoginForm onError={handleLoginError} />
        </div>
        ...
        <div className="p-6 border-t border-gray-200 bg-gray-50 rounded-b-lg">
          <div className="text-center space-y-2">
            <p className="text-sm text-gray-600">
              Pas encore de compte producteur ?{' '}
              <Link href="/producteur-register" className="text-primary hover:text-primary-dark font-medium">
                Créer un compte
              </Link>
            </p>
            <p className="text-sm text-gray-600">
