...
async function handlePatch(req: NextApiRequest, res: NextApiResponse) {
    try {
        ...
        const updateData: Prisma.GrowerStandProductUncheckedUpdateInput = {};
        ...
        const updatedStandProduct = await prisma.growerStandProduct.update({
            where: { id },
            data: updateData,
            include: {
                product: true,
...
async function handleDelete(req: NextApiRequest, res: NextApiResponse) {
    try {
        ...
        await prisma.growerStandProduct.delete({
            where: { id }
        });
