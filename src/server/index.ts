...
const customerUseCases = new CustomerUseCases(customerRepository, jwtService, checkoutRepository);
...
const growerUseCases = new GrowerUseCases(growerRepository, jwtService);
